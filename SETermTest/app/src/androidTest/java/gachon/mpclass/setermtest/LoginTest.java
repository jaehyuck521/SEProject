...
public class LoginTest {
    ...
    public void mainTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editPassword),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("12344"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edit_user_name),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("chaeyoon"), closeSoftKeyboard());

        // Click Student button (user infomation)
        ViewInteraction appCompatImageButton3 = onView(
                allOf(withId(R.id.btn_student),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        // Check screen movement between menus through fragment
        ViewInteraction appCompatImageView2 = onView(
                allOf(withId(R.id.my_page),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
