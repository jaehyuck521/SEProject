...
public  class SqliteOpenhelper extends SQLiteOpenHelper{
    ...
    //create the two table, group table and user table for convenient management
    ...
    //the version changes, it will upgrade and update version
