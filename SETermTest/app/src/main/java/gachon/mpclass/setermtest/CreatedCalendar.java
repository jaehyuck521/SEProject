...
public class CreatedCalendar extends AppCompatActivity {
    ...
    private String except_and_push(){
        ...
        int part3_from_hour = intent.getExtras().getInt("part3_from_hour");
        ...
        for(int i=0; i<list.size(); i++){
            switch (rest1[i]) {
                case 7 :  break;
                case 0 : rest[0][i] = 1; break;
                case 1 : rest[1][i] = 1; break;
                case 2 : rest[2][i] = 1; break;
                case 3 : rest[3][i] = 1; break;
                case 4 : rest[4][i] = 1; break;
                case 5 : rest[5][i] = 1; break;
                case 6 : rest[6][i] = 1; break;
            }
            switch (rest2[i]) {
                case 7 :  break;
                case 0 : rest[0][i] = 1; break;
...
//PART 1
        for(int i=0; i<time_split[0];i++){
            ...
            textView0.setBackgroundColor(Color.RED);
            ...
            textView3.setBackgroundColor(Color.MAGENTA);
...
//PART 2
        for(int i=time_split[0]; i<time_split[0]+time_split[1];i++){
            ...
            textView6.setBackgroundColor(Color.DKGRAY);
        ...
        for(int i=time_split[1]+time_split[0]; i<hours;i++){
            ...
            textView0.setBackgroundColor(Color.DKGRAY);
            ...
            textView6.setBackgroundColor(Color.MAGENTA);
...
//        id[0] = getResources().getIdentifier(sun[i], type, pack);
        ...
        int j=0;
        for(int i=0; i<24; i++){
            id[j]= getResources().getIdentifier(sunid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(monid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(tueid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(wenid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(thuid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(friid[i], type, pack); j++;
            id[j]= getResources().getIdentifier(satid[i], type, pack); j++;
        }
